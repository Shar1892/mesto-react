  ...
  return (
    <PopupWithForm name="profile" title="Редактировать профиль" isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit}>
      <div className="overlay__input-container">
        <input type="text" id="user-name-input" className="overlay__input overlay__input_type_user-name" name="name" value={name} onChange={handleChangeName} minLength="2" maxLength="40" required />
        <span className="overlay__input-error overlay__user-name-input-error"></span>
      </div>
      <div className="overlay__input-container">
        <input type="text" id="user-activity-input" className="overlay__input overlay__input_type_user-activity" name="about" value={discription} onChange={handleChangeDiscription} minLength="2" maxLength="200" required />
